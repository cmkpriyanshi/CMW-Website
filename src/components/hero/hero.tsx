      ...
      <div className="mt-16 flex flex-col items-center gap-6">
        ...
        <div ref={containerRef} className="relative flex w-full justify-center items-start gap-4 sm:gap-8 pb-32 px-4">
          <motion.div style={{ y: yOffset }} className="hidden sm:block shrink-0 z-0">
            <Image src="/mockups/vault.png" alt="App Left" width={400} height={585} />
          </motion.div>
          <div className="z-10 shrink-0">
            <Image src="/mockups/warranty.png" alt="Hero Middle" width={400} height={585} />
          </div>
          <motion.div style={{ y: yOffset }} className="hidden sm:block shrink-0 z-0">
            <Image src="/mockups/reminder.png" alt="App Right" width={400} height={585} />
          </motion.div>
        </div>
      </div>
    </div>
