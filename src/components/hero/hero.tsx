...
export function Hero() {
  ...
  // Map scroll progress 0->1 to y offset 96px->0px
  const yOffset = useTransform(scrollYProgress, [0, 1], [96, 0]);
  ...
  return (
    <div className="z-1 relative grid w-full place-items-center p-8 overflow-hidden">
      ...
      <div className="mt-16 flex flex-col items-center gap-6">
        ...
        <div ref={containerRef} className="relative flex w-full justify-center items-start gap-4 sm:gap-8 pb-32 px-4">
          <motion.div style={{ y: yOffset }} className="hidden sm:block shrink-0 z-0">
            <Image src="/mockups/vault.png" alt="App Left" width={400} height={585} className="w-full h-auto max-w-[400px]" />
          </motion.div>
          <div className="z-10 w-full max-w-[400px] sm:shrink-0">
            <Image src="/mockups/warranty.png" alt="Hero Middle" width={400} height={585} className="w-full h-auto" />
          </div>
          <motion.div style={{ y: yOffset }} className="hidden sm:block shrink-0 z-0">
            <Image src="/mockups/reminder.png" alt="App Right" width={400} height={585} className="w-full h-auto max-w-[400px]" />
          </motion.div>
        </div>
      </div>
    </div>
